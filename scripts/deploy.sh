...
gcloud run deploy ${SERVICE_NAME} \
  ...
  --set-secrets=DATABASE_URL=DATABASE_URL:latest,SECRET_KEY=SECRET_KEY:latest,STRIPE_SECRET_KEY=STRIPE_SECRET_KEY:latest,STRIPE_WEBHOOK_SECRET=STRIPE_WEBHOOK_SECRET:latest,STRIPE_PRICE_ID_PRO=STRIPE_PRICE_ID_PRO:1,STRIPE_PRICE_ID_CENTER=STRIPE_PRICE_ID_CENTER:1,TWILIO_ACCOUNT_SID=TWILIO_ACCOUNT_SID:latest,TWILIO_AUTH_TOKEN=TWILIO_AUTH_TOKEN:latest,TWILIO_WHATSAPP_NUMBER=TWILIO_WHATSAPP_NUMBER:latest,OPENAI_API_KEY=OPENAI_API_KEY:latest,GOOGLE_API_KEY=GOOGLE_API_KEY:latest,GOOGLE_CLIENT_ID=GOOGLE_CLIENT_ID:latest,GOOGLE_CLIENT_SECRET=GOOGLE_CLIENT_SECRET:latest,BREVO_API_KEY=BREVO_API_KEY:latest,META_APP_SECRET=META_APP_SECRET:latest,META_ACCESS_TOKEN=META_ACCESS_TOKEN:latest,META_VERIFY_TOKEN=META_VERIFY_TOKEN:latest,META_PHONE_NUMBER_ID=META_PHONE_NUMBER_ID:latest \
